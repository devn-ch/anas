...
- date: 2026-09-14 04:12:23  node: anas-pve  kernel: 7.0.14-12-pve
...
| 7-txprobe | the tx-probe transaction touched no DATA chunk (the measured housekeeping set has no blind spot for the R1 assertion) | PASS | 56 band-A blocks measured, 0 in a data chunk |
...
| 7-bandA-untouched | no DATA write on band A: every changed band-A sector is btrfs superblock/metadata housekeeping (the R1 assertion) | PASS | changed sectors: 114 — housekeeping=114 data=0 |
